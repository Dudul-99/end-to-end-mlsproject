...
'''
This class is responsible for reading the data from the given path and splitting it into train and test data
It saves the train and test data in the artifacts folder
'''
@dataclass
